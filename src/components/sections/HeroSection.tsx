        ...
        <div className="max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
            <div className="border-2 border-border bg-background p-4 md:p-6 shadow-xs">
              ...
              <div className="text-sm text-muted-foreground">{t("hero.professionals")}</div>
            </div>
            <div className="border-2 border-border bg-background p-4 md:p-6 shadow-xs">
              <Globe className="w-6 h-6 mb-2" />
              <div className="text-3xl md:text-4xl font-bold">15+</div>
              <div className="text-sm text-muted-foreground">{t("hero.destinations")}</div>
            </div>
            <div className="border-2 border-border bg-background p-4 md:p-6 shadow-xs">
              <Briefcase className="w-6 h-6 mb-2" />
              <div className="text-3xl md:text-4xl font-bold">200+</div>
              <div className="text-sm text-muted-foreground">{t("hero.positions")}</div>
            </div>
          </div>
        </div>
      </div>
