      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <a href="#inicio" className="flex items-center">
            <img src={logoGhc} alt="Global Hiring & Careers" className="h-10 md:h-12" />
          </a>
          ...
          <nav className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  {link.label}
                  {/* Linha de destaque Neo-brutalista */}
                  <span className={cn(
          ...
          <div className="hidden md:block">
            <Button
              ...
              className="font-bold border-2 border-border shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all"
            >
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 border-2 border-border bg-background shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all"
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "bg-primary text-primary-foreground border-border shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
